...
\emph{Note:} The sufficiency direction ((i)+(ii) $\Rightarrow$
saturation) and the necessity of~(ii) within the commuting case
are proved analytically below.  The necessity of~(i) (that
non-commuting outputs preclude saturation) is supported by
$5\times 10^5$ numerical instances with zero exceptions;
an analytical proof remains open (see Step~5).

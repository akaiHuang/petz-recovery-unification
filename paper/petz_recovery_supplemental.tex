...
Work in the eigenbasis of $\tau = \sum_j t_j \ket{e_j}\!\bra{e_j}$
...
degenerate eigenspaces of $\tau$, forcing
$[\omega,\tau] = 0$).  Therefore the gap is strictly positive
at second order.
...
$1.3\times 10^5$ random non-commuting $(\omega,\tau)$ pairs in

...
When (i) fails ($[\omega,\tau] \neq 0$), $F^2$ cannot be written
as a simple scalar arithmetic mean of likelihood ratios.
The matrix version of the AM--GM inequality (operator AM--GM)
gives strict inequality.  This is confirmed
numerically: among $5\times 10^5$ random non-commuting
$(\omega,\tau)$ pairs, zero achieve saturation.

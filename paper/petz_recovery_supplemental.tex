...
(Theorem~3 of the main text, $\sigma = I/d$), the bound
...
The new mathematical results are Theorem~3 (saturation
characterization) and Theorem~4 (composition sub-additivity).
...
We prove Theorem~3 of the main text: a complete characterization
...
(Theorem~4), with $\tauasym_2^{\mathrm{eff}}$ evaluated at
...
\emph{Base case ($n = 2$).}
This is exactly Theorem~4 (Eq.~\eqref{eq:comp_supp}), proved in
Sec.~\ref{sec:S18}.

...
recovery strategy. Recent evidence supports this structure:
...
Detailed experimental proposals, including a protocol for simultaneous
$F$ and $\Sigma$ measurement on a superconducting qubit platform and
strategies for reanalyzing existing data, are given in the
Supplemental Material~\cite{SM}.

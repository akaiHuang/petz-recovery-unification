...
When (i) fails ($[\omega,\tau]\neq 0$), the matrix AM--GM
inequality gives strict inequality; this is confirmed
numerically for $5\times 10^5$ random non-commuting pairs
with zero exceptions~\cite{SM}.
\hfill$\square$

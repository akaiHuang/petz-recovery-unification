...
($\tilde{w}(z\!=\!1100) \approx 3 \times 10^{-10}$, dust-like)
...
\begin{equation}
\tilde{w}(z) = \frac{\delta_0}{2}
\!\left(\frac{H_0}{H(z)}\right)^{\!2},
\label{eq:w0_dust}
\end{equation}
where $\delta_0 = 0.340$ (fixed by $\Omega_{\mathrm{cdm}}$).
At recombination ($z \approx 1100$, $H/H_0 \approx 2.35
\times 10^4$), $\tilde{w} \approx 3 \times 10^{-10}$:
the Khronon is effectively pressureless, with
$c_s^2 \lesssim \tilde{w} \approx 3 \times 10^{-10}$
at all CMB scales~\cite{TKS2016}.
